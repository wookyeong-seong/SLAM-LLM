...
train_data_path=/workspace/tools/SLAM-LLM/examples/asr_librispeech/data/kspon-drama1k-kor-nopunc/train.jsonl
val_data_path=/workspace/tools/SLAM-LLM/examples/asr_librispeech/data/kspon-drama1k-kor-nopunc/valid.jsonl

output_dir=${run_dir}/output/phi-3.5-mini-instruct-librispeech-LoRA-linear-steplrwarmupkeep1e-4-wavlm-large-$(date +"%Y%m%d%H%M")
