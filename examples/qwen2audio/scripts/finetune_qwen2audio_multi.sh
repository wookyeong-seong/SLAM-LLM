...
train_data_path=/workspace/tools/SLAM-LLM/examples/asr_librispeech/data/kspon-drama1k-kor-nopunc-20sec/train.jsonl,/workspace/tools/SLAM-LLM/examples/qwen2audio/data/audiocaps/train_kor.jsonl,/workspace/tools/SLAM-LLM/examples/qwen2audio/data/clotho/train_kor.jsonl,/workspace/tools/SLAM-LLM/examples/qwen2audio/data/musiccaps/train_kor.jsonl
val_data_path=/workspace/tools/SLAM-LLM/examples/asr_librispeech/data/kspon-drama1k-kor-nopunc-20sec/valid.jsonl,/workspace/tools/SLAM-LLM/examples/qwen2audio/data/audiocaps/val_kor.jsonl,/workspace/tools/SLAM-LLM/examples/qwen2audio/data/clotho/val_kor.jsonl,/workspace/tools/SLAM-LLM/examples/qwen2audio/data/musiccaps/val_kor.jsonl
...
output_dir=${run_dir}/output/qwen2audio-lora-aac-kspon-drama1k-kor-nopunc-20sec
