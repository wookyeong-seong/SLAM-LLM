#from slam_llm.pipeline.inference_batch_qwen import main as inference
from slam_llm.pipeline.inference_batch_qwen_ddp import main as inference
...
from asr_config_qwen2audio import ModelConfig, TrainConfig, DataConfig, LogConfig, FSDPConfig
